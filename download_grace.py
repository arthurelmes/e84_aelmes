...
def dl_data(date_start, date_end):
    ...
    while date_end > date_start:
        ...
        base_url = 'https://podaac-tools.jpl.nasa.gov/drive/files/allData/tellus/L3/gracefo/land_mass/RL06/v03/JPL/'
        file_front = 'GRD-3_'
        file_date = '{x}-{y}'.format(x=date_start_doy, y=date_next_doy)
        file_end = '_GRFO_JPLEM_BA01_0600_LND_v03.tif'
...
if __name__ == '__main__':
    ...
    date_0 = datetime.strptime('2018-06-01', '%Y-%m-%d')
    date_1 = datetime.strptime('2018-12-01', '%Y-%m-%d')
